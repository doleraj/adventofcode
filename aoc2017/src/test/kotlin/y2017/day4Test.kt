...
class day4Test {
    ...
    @Test
    fun test1() {
        assertEquals(1, day4(arrayOf("aa bb cc dd ee")))
    }

    @Test
    fun test2() {
        assertEquals(0, day4(arrayOf("aa bb cc dd aa")))
    }

    @Test
    fun test3() {
        assertEquals(1, day4(arrayOf("aa bb cc dd aaa")))
    }

    @Test
    fun testActual() {
        assertEquals(386, day4(passphrases))
    }

    @Test
    fun test1Second() {
        assertEquals(1, day4Second(arrayOf("abcde fghij")))
    }

    @Test
    fun test2Second() {
        assertEquals(0, day4Second(arrayOf("abcde xyz ecdab")))
    }

    @Test
    fun test3Second() {
        assertEquals(1, day4Second(arrayOf("a ab abc abd abf abj")))
    }

    @Test
    fun test4Second() {
        assertEquals(1, day4Second(arrayOf("iiii oiii ooii oooi oooo")))
    }

    @Test
    fun test5Second() {
        assertEquals(0, day4Second(arrayOf("oiii ioii iioi iiio")))
    }

    @Test
    fun testActualSecond() {
        assertEquals(208, day4Second(passphrases))
    }
}
